...
from vacuum_2d_gui import maze4x4, maze6x6, maze8x8, maze10x10, build_vacuum_env
from vacuum_2d import RandomVacuumAgent, ReflexVacuumAgent, ModelBasedVacuumAgent, AdvancedModelBasedVacuumAgent
...
class Comparison:
    def __init__(self, canvas, interrupted, done_observer, nb_run=10):
        self.agent_factories = [RandomVacuumAgent, ReflexVacuumAgent, ModelBasedVacuumAgent]
        self.mazes2d = [maze4x4, maze6x6, maze8x8, maze10x10]
    ...
    def next_test(self):
        ...
        if self.a < len(self.agent_factories) and not self.interrupted.get():
            ...
            for i in range(self.nb_run):
                env = build_vacuum_env(self.mazes2d[self.m], agent_factory)
                env.run()
    ...
    def plot(self):
        ...
        maze_lab = ['maze4x4', 'maze6x6', 'maze8x8', 'maze10x10']
